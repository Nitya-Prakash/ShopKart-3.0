...
const BuyNow = () => {
    ...
    const placeOrder = () => {
        Object.values(val).some(value => !value) ? alert("Please add your address !") : navigate("/paymentGateway");
    }
            ...
            <div className='max-w-screen-xl h-[65vh] m-auto mt-4 rounded-lg p-5 bg-zinc-100 flex justify-between'>
                <div className='w-[70%] h-full rounded-md overflow-y-scroll flex flex-col gap-2'>
                    <div className='w-[98%] h-[40%] rounded-md bg-white border border-zinc-500 px-3 flex gap-5 py-1'>
                        ...
                        <div>
                            ...
                            <h1 className='mt-3 text-lg font-medium text-red-600'>$ {2362 * quantity}</h1>
                        </div>
                    </div>
                </div>
                <div className='w-[28%] h-full bg-zinc-200 rounded-md p-3 flex items-end'>
                    <div className='w-full'>
                        ...
                        <h1 className='flex items-center justify-between mt-2 text-lg font-bold'>Total Amount <span className='text-red-600'>$ {2362 + platformFee + shippingFee}</span></h1>
