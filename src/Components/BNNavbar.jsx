    ...
    return (
        <div className='max-w-screen-xl h-16 m-auto flex items-center justify-between border-b border-gray-300'>
            ...
            <div className='flex gap-2 w-[70%] items-center justify-center'>
                ...
                <span>-------</span>
                <h2 className={`tracking-widest uppercase text-sm`}>Address</h2>
                <span>-------</span>
                <h2 className={`tracking-widest uppercase text-sm`}>Payment</h2>
            </div>
            <div className='flex gap-2 items-center w-[15%] h-full justify-end'>
